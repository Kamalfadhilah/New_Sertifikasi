    ...
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            {{-- <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href=""><img src="{{url('images')}}/pinventory-logo-nobg(1).png" alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href=""><img src="{{url('images')}}/logo-box.png" alt="logo" /></a>
            </div> --}}
            <ul class="nav">
                <li class="nav-item nav-profile">
                    <a href="#" class="nav-link">
                        ...
                        <div class="nav-profile-text d-flex flex-column pr-3">
                            ...
                            <span class="font-weight-normal">{{Auth::user()->is_admin == 'y' ? 'Administrator' : 'Mahasiswa'}}</span>
                        </div>
                    </a>
                </li>
                @if(Auth::user()->is_admin == 'y')
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/users/show_user')}}">
                            <span class="menu-title">User</span>
                        </a>
                    </li>
                @endif
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/pendaftaran/show_pendaftaran')}}">
                        ...
                        <div class="mt-4">
                            <ul class="mt-4 pl-0">
                                <li>
                                    ...
                                    <form id="logout" action="{{url('/logout')}}" method="POST" class="d-none">
                                        @csrf
                                    </form>
                                </li>
                            </ul>
        ...
        <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © by Kamal Fadhilah</span>
            </div>
        </footer>
    </div>
    <!-- container-scroller -->
